...
>>> md.convert(':smile:')
'<p><img class="marked-emoji" src="https://example.com/emoji/smile.png" /></p>'
>>>
"""
...
EMOJI_URL = "https://github.githubassets.com/images/icons/emoji/"
EMOJI_RE = r"(:[+\-\w]+:)"
EMOJIS = [
    ":yellow_heart:",
    ":blue_heart:",
...
class EmojiExtension(Extension):
    def extendMarkdown(self, md):
        ...
        md.inlinePatterns.register(EmojiPattern(EMOJI_RE, md), "emoji_img", 40)
